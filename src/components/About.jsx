    ...
    <Tilt className='xs:w-[210px] w-full cursor-pointer'>
      ...
      >
        <div
          ...
          className={` ${darklight ? 'bg-[#191F2F]' : 'bg-[#eee]'}  rounded-[10px] py-5 px-12 min-h-[280px] flex justify-evenly items-center flex-col`}
        >
          <img
            src={icon}
            alt='web-development'
          ...
          <h3 className={` ${darklight ? 'text-slate-100' : 'text-gray-700'} text-[20px] monospace font-bold text-center`}>
            {title} 
          </h3>
        </div>
      </motion.div>
...
const About = () => {
  ...
  return (
    <div className="w-full h-[93vh]    overflow-hidden frc justify-center">
      ...
      >
        I'm a skilled web developer with experience in <span className=" text-blue-500 ">TypeScript</span> and  <span className=" text-yellow-500"> JavaScript</span>, and expertise in frameworks like <span className=" text-cyan-500">React</span>, <span className="  text-teal-500"> Node.js</span>, and
        <span className="text-black "> Next js</span>. I'm a quick learner and collaborate closely with clients to
      ...
      >
        <p  className="text-[15px] monospace 550:text-[15px] 800:text-[20px] hidden 500:inline ">
          My passion for web development began when I
