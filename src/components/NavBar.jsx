...
function NavBar() {
  ...
  return (
    ...
    className={`w-full h-[7vh]      shadow-lg ${darklight ? 'shadow-cyan-500/50' : ''}   flex flex-row items-center justify-between  z-[999] `}
  >
    <div      
    ...
    <div className="w-auto z-[999]  800:w-[500px] group h-[60px] animate-slidedown  rounded-[5px] text-[18px] frc justify-between select-none">
      ...
      <div className="mr-[10px] 500:mr-[20px] frc  ">
        ...
        <div
          className={` ${darklight ? 'bg-[#10141e]' : 'bg-[#EEEEEE]'}  z-50  shadow-lg hidden group-hover:flex fcc w-[180px] 500:w-[200px] h-[250px] mr-[5px] 500:mr-[15px]  animate-slowfade3 rounded-[10px] absolute right-0 bottom-[-260px] z-[999]
 `}
        >           
          <div className=" absolute right-0 top-[-16px] mr-[9px] ">
            <VscTriangleUp className={` text-[25px] ${darklight ? 'text-[#10141e]' : 'text-[#e0e0e0]'}   `} />
          </div>
          <div className='w-full h-full overflow-hidden '>
          <a
            href="#About"
            className={`w-full h-[60px] monospace frc justify-center text-[16px] 500:text-[19px] ${isActive === 'About' ? 'text-orange-500 ' : ''} hover:text-teal-400 cursor-pointer ScaleAnimation `}
          >
            About
          </a>
          <a
            href="#Skills"
            className={` ${isActive === 'Skills' ? 'text-orange-500 ' : ''} monospace w-full h-[60px] frc justify-center text-[16px] 500:text-[19px] hover:text-teal-400 cursor-pointer ScaleAnimation`}
          >
            Skills
          </a>
          <a
            href="#Projects"
            className={` ${isActive === 'Projects' ? 'text-orange-500 ' : ''} monospace w-full h-[60px] frc justify-center text-[16px] 500:text-[19px] hover:text-teal-400 cursor-pointer ScaleAnimation`}
          >
            Projects
          </a>
          <a
            href="#Contact"
            className={`${isActive === 'Contact' ? 'text-orange-500 ' : ''} monospace w-full h-[60px] frc justify-center text-[16px] 500:text-[19px] hover:text-teal-400 cursor-pointer ScaleAnimation `}
          >
            Contact
          </a>
          </div>
